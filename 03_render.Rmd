...
Below are the skills clusters and analysis

```{r, fig8, fig.cap="All Occupations: Percent of Job Openings 2025", fig.width=9, fig.height=5.5, dpi=400, out.width="110%"}
all_occs_chart
```

```{r, fig9, fig.cap="Management and University", fig.width=9, fig.height=5.5, dpi=400, out.width="110%"}
plot_upper
```

```{r fig10, fig.cap="College/Apprenticeship and Highschool or less", fig.width=9, fig.height=5.5, dpi=400, out.width="110%"}
plot_lower
```
