...
```{r, fig1, fig.cap="Skills Fig 1", fig.width=9, fig.height=5.5, dpi=400, out.width="110%"}
ro$emp_teer_plt 
```
...
```{r, fig5, fig.cap="Skills Fig 5", fig.width=9, fig.height=5.5, dpi=400, out.width="110%"}
ro$crossed_plt1
```

```{r, fig6, fig.cap="Skills Fig 6", fig.width=9, fig.height=5.5, dpi=400, out.width="110%"}
ro$crossed_plt2
```

```{r fig7, fig.cap="Skills Fig 7", fig.width=9, fig.height=5.5, dpi=400, out.width="110%"}
ro$crossed_plt3 
```
